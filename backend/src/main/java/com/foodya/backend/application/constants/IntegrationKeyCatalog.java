...
public final class IntegrationKeyCatalog {

    private IntegrationKeyCatalog() {
    }
    ...
    public static final String GOONG_API_KEY = "goong.api.key";

    public static final String FIREBASE_API_KEY = "firebase.api.key";
    public static final String FIREBASE_AUTH_DOMAIN = "firebase.auth.domain";
    public static final String FIREBASE_PROJECT_ID = "firebase.project.id";
    public static final String FIREBASE_STORAGE_BUCKET = "firebase.storage.bucket";
