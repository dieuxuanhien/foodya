...
public final class SystemParameterCatalog {
    ...
    public static Map<String, ParameterRule> defaults() {
        ...
        rules.put("retention.tracking_points_days", ParameterRule.number("30", false, new NumberConstraint(BigDecimal.ONE, null)));
        rules.put("retention.ai_chat_days", ParameterRule.number("90", false, new NumberConstraint(BigDecimal.ONE, null)));
