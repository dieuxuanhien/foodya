...
public class SystemParameterService {
    ...
    public List<SystemParameter> listAll() {
        return systemParameterPort.findAllOrderedByKey();
    }

    @Transactional
    public SystemParameter replace(String key, SystemParameterPutRequest request, String actorRole, String actorId) {
    ...
    @Transactional
    public SystemParameter patch(String key, SystemParameterPatchRequest request, String actorRole, String actorId) {
        assertAdmin(actorRole);
        SystemParameter existing = requiredParameter(key);
        SystemParameterCatalog.ParameterRule rule = requiredRule(key);
        String oldSnapshot = snapshot(existing);
