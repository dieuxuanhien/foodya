...
import com.foodya.backend.interfaces.rest.dto.SystemParameterPatchApiRequest;
...
public class AdminSystemParameterController {

    private final SystemParameterUseCase systemParameterService;

    public AdminSystemParameterController(SystemParameterUseCase systemParameterService) {
    ...
    public ResponseEntity<ApiSuccessResponse<List<SystemParameterResponse>>> list(HttpServletRequest httpServletRequest) {
        List<SystemParameterResponse> data = systemParameterService.listAll()
                .stream()
                .map(CommonApiMapper::toSystemParameterResponse)
                .toList();
    ...
    public ResponseEntity<ApiSuccessResponse<SystemParameterResponse>> put(@PathVariable String key,
        ...
        SystemParameterData updated = systemParameterService.replace(key, command, actorRole, actorId);
