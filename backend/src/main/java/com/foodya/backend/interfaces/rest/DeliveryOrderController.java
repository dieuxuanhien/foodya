...
public class DeliveryOrderController {
    ...
    public DeliveryOrderController(OrderLifecycleService orderLifecycleService) {
    ...
    public ApiSuccessResponse<OrderDetailResponse> accept(@PathVariable UUID orderId,
        ...
        OrderDetailResponse data = OrderLifecycleRestMapper.toDetail(orderLifecycleService.deliveryAccept(orderId));
        return ApiSuccessResponse.of(data, RequestTrace.from(request));
    }
    ...
    public ApiSuccessResponse<OrderDetailResponse> updateStatus(@PathVariable UUID orderId,
        ...
        OrderDetailResponse data = OrderLifecycleRestMapper.toDetail(orderLifecycleService.deliveryUpdateStatus(orderId, targetStatus));
        return ApiSuccessResponse.of(data, RequestTrace.from(request));
    }
